...
func CheckLogin(c *fiber.Ctx) error {
	...
	result, idcompany, ruleadmin, err := models.Login_Model(client.Username, client.Password, client.Ipaddress)
	...
	if !result {
		...
		dataclient := client.Username + "==" + idcompany + "==" + ruleadmin
...
func Home(c *fiber.Ctx) error {
	...
	client_username, company, idruleadmin := helpers.Parsing_Decry(temp_decp, "==")
